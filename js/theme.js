...
var imageCarousel = $('.img-ezousel');
var partnersCarousel = $('#partners');
var testimonialsCarousel = $('#testimonials');
var testimonialsCarouselAlt = $('#testimonials-alt');
var carCarousel = $('.ez-ezousel');
var topProductsCarousel = $('#top-products-ezousel');
var featuredProductsCarousel = $('#featured-products-ezousel');
var sidebarProductsCarousel = $('#sidebar-products-ezousel');
var hotDealsCarousel = $('#hot-deals-ezousel');
var owlCarouselSelector = $('.owl-ezousel');
...
jQuery(document).ready(function () {
    ...
    if ($().swiper) {
        ...
        if (swiperSlider1x1.length) {
            swiperSlider1x1 = new Swiper(swiperSlider1x1, {
                pagination: '#swiperSlider1x1 .row.ez-thumbnails',
                paginationClickable: true,
                paginationBulletRender: function (index, className) {
                    return '<div class="col-xs-2 col-sm-2 col-md-3 ' + className + '"><a href="#"><img src="assets/img/preview/cars/ez-70x70x' + (index + 1) + '.jpg" alt=""/></a></div>';
                }
            });
        }
        if (swiperSlider1x2.length) {
            swiperSlider1x2 = new Swiper(swiperSlider1x2, {
                pagination: '#swiperSlider1x2 .row.ez-thumbnails',
                paginationClickable: true,
                paginationBulletRender: function (index, className) {
                    return '<div class="col-xs-2 col-sm-2 col-md-3 ' + className + '"><a href="#"><img src="assets/img/preview/cars/ez-70x70x' + (index + 1) + '.jpg" alt=""/></a></div>';
                }
        ...
        if (swiperSlider1x3.length) {
            swiperSlider1x3 = new Swiper(swiperSlider1x3, {
                pagination: '#swiperSlider1x3 .row.ez-thumbnails',
                paginationClickable: true,
                paginationBulletRender: function (index, className) {
                    return '<div class="col-xs-2 col-sm-2 col-md-3 ' + className + '"><a href="#"><img src="assets/img/preview/cars/ez-70x70x' + (index + 1) + '.jpg" alt=""/></a></div>';
                }
        ...
        if (swiperSlider1x4.length) {
            swiperSlider1x4 = new Swiper(swiperSlider1x4, {
                pagination: '#swiperSlider1x4 .row.ez-thumbnails',
                paginationClickable: true,
                paginationBulletRender: function (index, className) {
                    return '<div class="col-xs-2 col-sm-2 col-md-3 ' + className + '"><a href="#"><img src="assets/img/preview/cars/ez-70x70x' + (index + 1) + '.jpg" alt=""/></a></div>';
                }
        ...
        if (swiperSlider1x5.length) {
            swiperSlider1x5 = new Swiper(swiperSlider1x5, {
                pagination: '#swiperSlider1x5 .row.ez-thumbnails',
                paginationClickable: true,
                paginationBulletRender: function (index, className) {
                    return '<div class="col-xs-2 col-sm-2 col-md-3 ' + className + '"><a href="#"><img src="assets/img/preview/cars/ez-70x70x' + (index + 1) + '.jpg" alt=""/></a></div>';
                }
        ...
        if (swiperSlider2x1.length) {
            swiperSlider2x1 = new Swiper(swiperSlider2x1, {
                pagination: '#swiperSlider2x1 .row.ez-thumbnails',
                paginationClickable: true,
                paginationBulletRender: function (index, className) {
                    return '<div class="col-xs-2 col-sm-2 col-md-3 ' + className + '"><a href="#"><img src="assets/img/preview/cars/ez-70x70x' + (index + 1) + '.jpg" alt=""/></a></div>';
                }
        ...
        if (swiperSlider2x2.length) {
            swiperSlider2x2 = new Swiper(swiperSlider2x2, {
                pagination: '#swiperSlider2x2 .row.ez-thumbnails',
                paginationClickable: true,
                paginationBulletRender: function (index, className) {
                    return '<div class="col-xs-2 col-sm-2 col-md-3 ' + className + '"><a href="#"><img src="assets/img/preview/cars/ez-70x70x' + (index + 1) + '.jpg" alt=""/></a></div>';
                }
        ...
        if (swiperSlider2x3.length) {
            swiperSlider2x3 = new Swiper(swiperSlider2x3, {
                pagination: '#swiperSlider2x3 .row.ez-thumbnails',
                paginationClickable: true,
                paginationBulletRender: function (index, className) {
                    return '<div class="col-xs-2 col-sm-2 col-md-3 ' + className + '"><a href="#"><img src="assets/img/preview/cars/ez-70x70x' + (index + 1) + '.jpg" alt=""/></a></div>';
                }
        ...
        if (swiperSlider2x4.length) {
            swiperSlider2x4 = new Swiper(swiperSlider2x4, {
                pagination: '#swiperSlider2x4 .row.ez-thumbnails',
                paginationClickable: true,
                paginationBulletRender: function (index, className) {
                    return '<div class="col-xs-2 col-sm-2 col-md-3 ' + className + '"><a href="#"><img src="assets/img/preview/cars/ez-70x70x' + (index + 1) + '.jpg" alt=""/></a></div>';
                }
        ...
        if (swiperSlider2x5.length) {
            swiperSlider2x5 = new Swiper(swiperSlider2x5, {
                pagination: '#swiperSlider2x5 .row.ez-thumbnails',
                paginationClickable: true,
                paginationBulletRender: function (index, className) {
                    return '<div class="col-xs-2 col-sm-2 col-md-3 ' + className + '"><a href="#"><img src="assets/img/preview/cars/ez-70x70x' + (index + 1) + '.jpg" alt=""/></a></div>';
                }
        ...
        if (swiperSlider3x1.length) {
            swiperSlider3x1 = new Swiper(swiperSlider3x1, {
                pagination: '#swiperSlider3x1 .row.ez-thumbnails',
                paginationClickable: true,
                paginationBulletRender: function (index, className) {
                    return '<div class="col-xs-2 col-sm-2 col-md-3 ' + className + '"><a href="#"><img src="assets/img/preview/cars/ez-70x70x' + (index + 1) + '.jpg" alt=""/></a></div>';
                }
        ...
        if (swiperSlider3x2.length) {
            swiperSlider3x2 = new Swiper(swiperSlider3x2, {
                pagination: '#swiperSlider3x2 .row.ez-thumbnails',
                paginationClickable: true,
                paginationBulletRender: function (index, className) {
                    return '<div class="col-xs-2 col-sm-2 col-md-3 ' + className + '"><a href="#"><img src="assets/img/preview/cars/ez-70x70x' + (index + 1) + '.jpg" alt=""/></a></div>';
                }
        ...
        if (swiperSlider3x3.length) {
            swiperSlider3x3 = new Swiper(swiperSlider3x3, {
                pagination: '#swiperSlider3x3 .row.ez-thumbnails',
                paginationClickable: true,
                paginationBulletRender: function (index, className) {
                    return '<div class="col-xs-2 col-sm-2 col-md-3 ' + className + '"><a href="#"><img src="assets/img/preview/cars/ez-70x70x' + (index + 1) + '.jpg" alt=""/></a></div>';
                }
        ...
        if (swiperSlider3x4.length) {
            swiperSlider3x4 = new Swiper(swiperSlider3x4, {
                pagination: '#swiperSlider3x4 .row.ez-thumbnails',
                paginationClickable: true,
                paginationBulletRender: function (index, className) {
                    return '<div class="col-xs-2 col-sm-2 col-md-3 ' + className + '"><a href="#"><img src="assets/img/preview/cars/ez-70x70x' + (index + 1) + '.jpg" alt=""/></a></div>';
                }
        ...
        if (swiperSlider3x5.length) {
            swiperSlider3x5 = new Swiper(swiperSlider3x5, {
                pagination: '#swiperSlider3x5 .row.ez-thumbnails',
                paginationClickable: true,
                paginationBulletRender: function (index, className) {
                    return '<div class="col-xs-2 col-sm-2 col-md-3 ' + className + '"><a href="#"><img src="assets/img/preview/cars/ez-70x70x' + (index + 1) + '.jpg" alt=""/></a></div>';
                }
        ...
        if (swiperSlider4x1.length) {
            swiperSlider4x1 = new Swiper(swiperSlider4x1, {
                pagination: '#swiperSlider4x1 .row.ez-thumbnails',
                paginationClickable: true,
                paginationBulletRender: function (index, className) {
                    return '<div class="col-xs-2 col-sm-2 col-md-3 ' + className + '"><a href="#"><img src="assets/img/preview/cars/ez-70x70x' + (index + 1) + '.jpg" alt=""/></a></div>';
                }
        ...
        if (swiperSlider4x2.length) {
            swiperSlider4x2 = new Swiper(swiperSlider4x2, {
                pagination: '#swiperSlider4x2 .row.ez-thumbnails',
                paginationClickable: true,
                paginationBulletRender: function (index, className) {
                    return '<div class="col-xs-2 col-sm-2 col-md-3 ' + className + '"><a href="#"><img src="assets/img/preview/cars/ez-70x70x' + (index + 1) + '.jpg" alt=""/></a></div>';
                }
        ...
        if (swiperSlider4x3.length) {
            swiperSlider4x3 = new Swiper(swiperSlider4x3, {
                pagination: '#swiperSlider4x3 .row.ez-thumbnails',
                paginationClickable: true,
                paginationBulletRender: function (index, className) {
                    return '<div class="col-xs-2 col-sm-2 col-md-3 ' + className + '"><a href="#"><img src="assets/img/preview/cars/ez-70x70x' + (index + 1) + '.jpg" alt=""/></a></div>';
                }
        ...
        if (swiperSlider4x4.length) {
            swiperSlider4x4 = new Swiper(swiperSlider4x4, {
                pagination: '#swiperSlider4x4 .row.ez-thumbnails',
                paginationClickable: true,
                paginationBulletRender: function (index, className) {
                    return '<div class="col-xs-2 col-sm-2 col-md-3 ' + className + '"><a href="#"><img src="assets/img/preview/cars/ez-70x70x' + (index + 1) + '.jpg" alt=""/></a></div>';
                }
        ...
        if (swiperSlider4x5.length) {
            swiperSlider4x5 = new Swiper(swiperSlider4x5, {
                pagination: '#swiperSlider4x5 .row.ez-thumbnails',
                paginationClickable: true,
                paginationBulletRender: function (index, className) {
                    return '<div class="col-xs-2 col-sm-2 col-md-3 ' + className + '"><a href="#"><img src="assets/img/preview/cars/ez-70x70x' + (index + 1) + '.jpg" alt=""/></a></div>';
                }
    ...
    if (typeof google === 'object' && typeof google.maps === 'object') {
        if ($('#map-canvas').length) {
            ...
            var mapIWcontent = '' +
                    ...
                    '<div class="thumbnail no-border no-padding thumbnail-ez-ezd">' +
                    '<div class="media">' +
                    '<a class="media-link" href="#">' +
                    '<img style="max-height: 185px;"src="assets/img/preview/cars/ez-270x220x1.png" alt=""/>' +
                    '<span class="icon-view"><strong><i class="fa fa-eye"></i></strong></span>' +
                    '</a>' +
                    '</div>' +
                    '<div class="caption text-center">' +
                    '<h4 class="caption-title"><a href="#">Fenway Stadium</a></h4>' +
                    '<div class="caption-text">Pickup Date & Time<br>21/02/2016 17:02</div>' +
                    '<div class="buttons">' +
                    // '<a class="btn btn-theme" href="#">Sign In</a>' +
                    '</div>' +
                    '<table class="table">' +
                    '<tr>' +
                    '<td><i class="fa fa-car"></i> Car</td>' +
                    '<td><i class="fa fa-people"></i>3 People</td>' +
                    '<td><i class="fa fa-person"></i> €367,85</td>' +
                    '</tr>' +
                    '</table>' +
                    '</div>' +
                    '</div>' +
            ...
            var contentString = '' +
                    ...
                    '' +
                    '';
            var image = 'assets/img/icon-google-map-v2.png'; // marker icon
            google.maps.event.addDomListener(window, 'load', function () {
                var mapOptions = {
                    scrollwheel: false,
                    zoom: 13,
                    center: new google.maps.LatLng(33.7676338,-84.5606889) // map coordinates
                };

                map = new google.maps.Map(document.getElementById('map-canvas'),
                        mapOptions);
                 marker = new google.maps.Marker({
                    position: new google.maps.LatLng(33.7776338,-84.5606889), // marker coordinates
                    map: map,
                    icon: image,
                    // title: 'Hello World!'
                });
                // marker2 = new google.maps.Marker({
                //     position: new google.maps.LatLng(33.7686338,-84.5606889), // marker coordinates
                //     map: map,
                //     icon: image,
                //     title: 'Hello World!'
                // });
                marker2 = new google.maps.Marker({
                    position: new google.maps.LatLng(33.76765538,-84.5206889), // marker coordinates
                    map: map,
                    icon: image,
                    // title: 'Hello World!'
                });
                // marker4 = new google.maps.Marker({
                //     position: new google.maps.LatLng(33.7376338,-84.5606889), // marker coordinates
                //     map: map,
                //     icon: image,
                //     title: 'Hello World!'
                // });
                // marker5 = new google.maps.Marker({
                //     position: new google.maps.LatLng(33.8676338,-84.5606889), // marker coordinates
                //     map: map,
                //     icon: image,
                //     title: 'Hello World!'
                // });
        ...
        if ($('#map-canvas-fs').length) {
            ...
            var mapIWcontent = '' +
                    ...
                    '<div class="media">' +
                    '<a class="media-link" href="#">' +
                    '<img src="assets/img/preview/cars/ez-270x220x1.jpg" alt=""/>' +
                    '<span class="icon-view"><strong><i class="fa fa-eye"></i></strong></span>' +
                    '</a>' +
                    '</div>' +
                    '<div class="caption text-center">' +
                    '<h4 class="caption-title"><a href="#">Caption Title</a></h4>' +
                    '<div class="caption-text">Pickup Date & Time<br>21/02/2016 17:02</div>' +
                    '<div class="buttons">' +
            ...
            google.maps.event.addDomListener(window, 'load', function () {
                ...
                marker3 = new google.maps.Marker({
                    position: new google.maps.LatLng(33.76765538,-84.5606889), // marker coordinates
                    map: map,
                    icon: image,
                    title: 'Hello World!'
                });
    ...
    // ---------------------------------------------------------------------------------------
    $('.ez-categories .arrow').on('click', function (event) {
    ...
    $('.ez-categories ul.children').each(function () {
        if (!$(this).hasClass('active')) {
            $(this).hide();
        }
    });
